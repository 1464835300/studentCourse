          ...
          >
            ...
            <el-table-column prop="isFreeze" label="状态">
              <template #default="scope">
                <span v-if="scope.row.isFreeze === 0" style="color: #16bc6a"
                  >激活</span
                >
            ...
            <el-table-column label="操作" width="150px">
              <template #default="scope">
                <el-button
                  size="small"
                  type="success"
                  @click="isActive(scope.row, 0)"
                  >激活</el-button
                >
                <el-button
                  size="small"
                  type="danger"
                  @click="isActive(scope.row, 1)"
                  >冻结</el-button
                >
              </template>
            </el-table-column>
...
const isActive = (data, type) => {
  ElMessageBox.confirm(`是否${type === 0 ? "激活" : "冻结"}?`, "提示", {
